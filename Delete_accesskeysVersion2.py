...
if __name__ == "__main__":
    # Define usernames to exclude from key deletion
    excluded_users = [
        'kandikuppa.krishna@herovired.com',
    ...
    for user in users:
        ...
        # Skip deleting access keys for excluded accounts
    ...
    print("Access keys for all users (except excluded ones) have been deleted.")
